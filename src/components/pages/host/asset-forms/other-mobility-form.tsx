...
export function OtherMobilityForm({ onBack, onNext }: { onBack: () => void; onNext: (data: any) => void }) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <input
          ...
          placeholder="e.g., Electric Scooter, Golf Cart, Segway"
      ...
      <div className="border-t pt-4">
        ...
        {formData.requiresOperator && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Operator Price per Day ($)</label>
            <input
              type="number"
              min="0"
